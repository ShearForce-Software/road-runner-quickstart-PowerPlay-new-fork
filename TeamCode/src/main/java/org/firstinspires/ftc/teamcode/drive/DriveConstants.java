...
public class DriveConstants {
     ...
     * empirically tuned.
     */
    public static double kV = 0.0102; //changed from .0115 -xavier
    public static double kA = 0.0025; // changed from 0.002 -xavier
    public static double kStatic = 0.06993; //changed from .068 -xavier
    ...
    public static double MAX_ANG_VEL = Math.toRadians(200);// Math.toRadians(200); //6.5; changed from 6.5 -Xavier
