...
public class DriveConstantsBackup {
     ...
     */
    public static double MAX_VEL = 70; //75;
    public static double MAX_ACCEL = 70; //75;
    public static double MAX_ANG_VEL = 6.5; // Math.toRadians(200); //6.5;
